...
function getAllPossibleCoordsBishop(pieceCoord) {
    ...
    i = (pieceCoord.i === 7) ? pieceCoord.i : pieceCoord.i + 1
    ...
    //Did 3 more directions - the Bishop 
    return res;
}
...
function getAllPossibleCoordsKnight(pieceCoord) {
    ...
    if (pieceCoord.i > 1 && pieceCoord.j < 7 ){
        nextCoord = { i: pieceCoord.i - 2, j: pieceCoord.j + 1 }
        if(isEmptyCell(nextCoord))res.push(nextCoord)
    }
    if (pieceCoord.i > 0 && pieceCoord.j < 6 ){
        nextCoord = { i: pieceCoord.i - 1, j: pieceCoord.j + 2 }
        if(isEmptyCell(nextCoord))res.push(nextCoord)
    } 
    if (pieceCoord.i > 1 && pieceCoord.j > 0 ){
        nextCoord = { i: pieceCoord.i - 2, j: pieceCoord.j - 1 }
        if(isEmptyCell(nextCoord))res.push(nextCoord)
        
    }
    if (pieceCoord.i > 0 && pieceCoord.j > 1 ){
        nextCoord = { i: pieceCoord.i - 1, j: pieceCoord.j - 2 }
        if(isEmptyCell(nextCoord))res.push(nextCoord)
        
    }
    if (pieceCoord.i < 6 && pieceCoord.j < 7 ){
        nextCoord = { i: pieceCoord.i + 2, j: pieceCoord.j + 1 }
        if(isEmptyCell(nextCoord))res.push(nextCoord)
        nextCoord = { i: pieceCoord.i + 2, j: pieceCoord.j + 1 }
        if(isEmptyCell(nextCoord))res.push(nextCoord)
    ...
    if (pieceCoord.i < 6 && pieceCoord.j > 0 ) {
        nextCoord = { i: pieceCoord.i + 2, j: pieceCoord.j - 1 }
        if(isEmptyCell(nextCoord))res.push(nextCoord)
        
    }
    if (pieceCoord.i < 7 && pieceCoord.j > 1 ) {
        nextCoord = { i: pieceCoord.i + 1, j: pieceCoord.j - 2 }
        if(isEmptyCell(nextCoord))res.push(nextCoord)
        
    }
    if (pieceCoord.i < 7 && pieceCoord.j < 6 ){
        nextCoord = { i: pieceCoord.i + 1, j: pieceCoord.j + 2 }
        if(isEmptyCell(nextCoord))res.push(nextCoord)
